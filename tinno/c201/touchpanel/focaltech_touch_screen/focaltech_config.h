...
#define FTS_DRIVER_NAME     "ft6336u"
...
#define FTS_VENDOR_ID3                         0x8a
#define FTS_VENDOR_ID4                         0x68	//DJ
/*
 * FW.i file for auto upgrade, you must replace it with your own
 * define your own fw_file, the sample one to be replaced is invalid
 * NOTE: if FTS_GET_VENDOR_ID_NUM > 1, it's the fw corresponding with FTS_VENDOR_ID
 */
#define FTS_UPGRADE_FW_FILE                      "include/firmware/TL_C200_DJ_FT6336U_480x960_Ver0x15_20180205_app.i"

/*
 * if FTS_GET_VENDOR_ID_NUM >= 2, fw corrsponding with FTS_VENDOR_ID2
 * define your own fw_file, the sample one is invalid
 */
#define FTS_UPGRADE_FW2_FILE                     "include/firmware/CBF9922-5.5_C200_FT6336U_480x960_V21_20180227_app.i"

/*
 * if FTS_GET_VENDOR_ID_NUM >= 3, fw corrsponding with FTS_VENDOR_ID3
 * define your own fw_file, the sample one is invalid
 */
#define FTS_UPGRADE_FW3_FILE                     "include/firmware/0x8A_CBF9922-5.5_C200_FT6336U_480x960_VA4_20180411_app.i"

#define FTS_UPGRADE_FW4_FILE                     "include/firmware/TL_C200_0x68_DJ_FT6336U_480x960_Ver0x32_20180410_app.i"
