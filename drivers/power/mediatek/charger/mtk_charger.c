...
static int tinno_custom_charger_init(struct charger_manager *info)
{
	...
	/*custom jeita CV*/
	info->data.jeita_temp_above_t4_cv_voltage = CUSTOM_JEITA_TEMP_ABOVE_T4_CV_VOLTAGE;
	info->data.jeita_temp_t3_to_t4_cv_voltage = CUSTOM_JEITA_TEMP_T3_TO_T4_CV_VOLTAGE;
	info->data.jeita_temp_t2_to_t3_cv_voltage = CUSTOM_JEITA_TEMP_T2_TO_T3_CV_VOLTAGE;
	info->data.jeita_temp_t1_to_t2_cv_voltage = CUSTOM_JEITA_TEMP_T1_TO_T2_CV_VOLTAGE;
	info->data.jeita_temp_t0_to_t1_cv_voltage = CUSTOM_JEITA_TEMP_T0_TO_T1_CV_VOLTAGE;
	info->data.jeita_temp_below_t0_cv_voltage = CUSTOM_JEITA_TEMP_BELOW_T0_CV_VOLTAGE;
	/*custom jeita temp threshold*/
	info->data.temp_t4_threshold = CUSTOM_TEMP_T4_THRESHOLD;
	info->data.temp_t4_thres_minus_x_degree = CUSTOM_TEMP_T4_THRES_MINUS_X_DEGREE;
	info->data.temp_t3_threshold = CUSTOM_TEMP_T3_THRESHOLD;
	info->data.temp_t3_thres_minus_x_degree = CUSTOM_TEMP_T3_THRES_MINUS_X_DEGREE;
	info->data.temp_t2_threshold = CUSTOM_TEMP_T2_THRESHOLD;
	info->data.temp_t2_thres_plus_x_degree = CUSTOM_TEMP_T2_THRES_PLUS_X_DEGREE;
	info->data.temp_t1_threshold = CUSTOM_TEMP_T1_THRESHOLD;
	info->data.temp_t1_thres_plus_x_degree = CUSTOM_TEMP_T1_THRES_PLUS_X_DEGREE;
	info->data.temp_t0_threshold = CUSTOM_TEMP_T0_THRESHOLD;
	info->data.temp_t0_thres_plus_x_degree = CUSTOM_TEMP_T0_THRES_PLUS_X_DEGREE;
	info->data.temp_neg_10_threshold = CUSTOM_TEMP_NEG_10_THRESHOLD;
	return 0;
}
#endif
