...
#ifdef CONFIG_TINNO_BATTERY_CHARGING_DATA_SUPPORT
#include <cust_battery_property.h>
#include <cust_battery_table.h>	/* BATTERY_PROFILE_STRUCT */
#else
...
#endif /*CONFIG_TINNO_CUSTOM_BATTERY_TABLE*/
...
#ifndef CONFIG_TINNO_CUSTOM_BATTERY_TABLE
#ifndef CONFIG_TINNO_BATTERY_CHARGING_DATA_SUPPORT
	fg_custom_init_from_dts(dev);
#endif
#endif
	return 0;
