 ...
 */
#define FTS_VENDOR_1_ID                         0x67                  //DiJing
#define FTS_VENDOR_2_ID                         0x82                  //HLT
#define FTS_VENDOR_3_ID                         0x8A				//HLT_R	
#define FTS_VENDOR_4_ID                         0x68                  //DiJing_R
/*
 ...
 */
 //FW for DiJing
#define FTS_UPGRADE_FW_APP                      "include/firmware/TL_C200_DJ_FT6336U_480x960_Ver0x15_20180205_app.i"
 ...
 */
 //FW for HeLiTai
#define FTS_UPGRADE_FW2_APP                     "include/firmware/CBF9922-5.5_C200_FT6336U_480x960_V21_20180227_app.i"

/*
 * if FTS_GET_VENDOR_ID_NUM == 3, fw corrsponding with FTS_VENDOR_3_ID
 * define your own fw_app, the sample one is invalid
 */
 //FW for HeLiTai with  resistance
#define FTS_UPGRADE_FW3_APP                     "include/firmware/0x8A_CBF9922-5.5_C200_FT6336U_480x960_VA3_20180303_app.i"

/*
 * if FTS_GET_VENDOR_ID_NUM == 4, fw corrsponding with FTS_VENDOR_4_ID
 * define your own fw_app, the sample one is invalid
 */
 //FW for DiJing with  resistance
#define FTS_UPGRADE_FW4_APP                      "include/firmware/TL_C200_DJ_FT6336U_480x960_Ver0x30_20180307_app.i"
