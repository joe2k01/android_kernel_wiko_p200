...
#if defined(CONFIG_PROJECT_C300)||defined(CONFIG_PROJECT_C200)||defined(CONFIG_PROJECT_P130)||defined(CONFIG_PROJECT_C201)||defined(CONFIG_PROJECT_P150)
...
static int __init disp_init(void)
{
	...
	#if defined(CONFIG_PROJECT_C300)||defined(CONFIG_PROJECT_C200)||defined(CONFIG_PROJECT_P130)||defined(CONFIG_PROJECT_P150)
	//printk("%s,line = %d\n", __func__,__LINE__);
