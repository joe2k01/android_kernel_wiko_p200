...
#define AF_DRVNAME "DW9800AF_IMX135_SUNWIN_P130_DRV"
...
static int s4DW9800AF_IMX135_SUNWIN_P130_ReadReg(unsigned short *a_pu2Result)
{
...
static inline int moveAF(unsigned long a_u4Position)
{
	...
	if (*g_pAF_Opened == 1) {
		...
		initdrv();
		ret = s4DW9800AF_IMX135_SUNWIN_P130_ReadReg(&InitPos);
...
/* ////////////////////////////////////////////////////////////// */
long DW9800AF_IMX135_SUNWIN_P130_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param)
{
	long i4RetValue = 0;
...
int DW9800AF_IMX135_SUNWIN_P130_Release(struct inode *a_pstInode, struct file *a_pstFile)
{

    LOG_INF("initdrv--Start\n");
...
int DW9800AF_IMX135_SUNWIN_P130_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened)
{
