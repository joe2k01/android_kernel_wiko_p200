...
#define USE_CHECK_REGISTER_0X12_VALUE
...
#if defined(USE_CHECK_REGISTER_0X12_VALUE)	
	unsigned char swap_temp=0;
#endif
...
#if defined(USE_CHECK_REGISTER_0X12_VALUE)
  mir3da_register_read(handle,NSA_REG_SWAP_POLARITY,&swap_temp);
      if(swap_temp !=0x0E )
      	{
            mir3da_register_write(handle,NSA_REG_SWAP_POLARITY,0x0E);
            printk("\n[mir3da]--error!!!--cyamon---SWAP--- [%x]\n", swap_temp);
      	}
#endif
