...
static int kxtj2_1009_factory_get_cali(int32_t data[3])
{
	...
	int cali[3] = { 0 };
//return 0;
	err = KXTJ2_1009_ReadCalibration(kxtj2_1009_i2c_client, cali);

	data[0] = cali[KXTJ2_1009_AXIS_X] * GRAVITY_EARTH_1000 / gsensor_gain.x;
	data[1] = cali[KXTJ2_1009_AXIS_Y] * GRAVITY_EARTH_1000 / gsensor_gain.y;
	data[2] = cali[KXTJ2_1009_AXIS_Z] * GRAVITY_EARTH_1000 / gsensor_gain.z;
	return 0;
}
...
#ifdef CONFIG_TINNO_PRODUCT_INFO
        FULL_PRODUCT_DEVICE_INFO(ID_GSENSOR, "KXTJ3-1057");
#endif
