...
#ifdef CONFIG_TINNO_PRODUCT_INFO
#if (defined(CONFIG_PROJECT_C200) || defined(CONFIG_PROJECT_C300))
    FULL_PRODUCT_DEVICE_INFO(ID_GSENSOR, "ICM-20608D");
#else
	FULL_PRODUCT_DEVICE_INFO(ID_GSENSOR, "ICM-20608D");
//    FULL_PRODUCT_DEVICE_INFO(ID_GSENSOR, icm206xx_accel_init_info.name);
#endif
#endif
