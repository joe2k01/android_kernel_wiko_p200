...
//
#define ALSPS_IOCTL_PS_CALI_START			_IOW(ALSPS, 0x20, int[2])
#define ALSPS_IOCTL_PS_SET_CALI			_IOW(ALSPS, 0x21, int[2])
#define ALSPS_IOCTL_PS_GET_CALI			_IOW(ALSPS, 0x22, int[2])
#define ALSPS_IOCTL_PS_CLR_CALI			_IO(ALSPS, 0x23)
#define ALSPS_IOCTL_PS_CALI_RAW_DATA				_IOR(ALSPS, 0x24, int)
//
#ifdef CONFIG_COMPAT
