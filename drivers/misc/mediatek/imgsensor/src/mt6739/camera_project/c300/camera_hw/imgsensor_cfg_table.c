...
#if defined(OV8856_SUNNY_P301_MIPI_RAW)
						{
							SENSOR_DRVNAME_OV8856_SUNNY_P301_MIPI_RAW,
							{
...
#endif
#if defined(S5K3P3ST_SUNWIN_C300_MIPI_RAW)
		{
			SENSOR_DRVNAME_S5K3P3ST_SUNWIN_C300_FRONT_MIPI_RAW,
			{
				{SensorMCLK1, Vol_High, 0},
				{PDN, Vol_Low, 1},
				{RST, Vol_Low, 1},
