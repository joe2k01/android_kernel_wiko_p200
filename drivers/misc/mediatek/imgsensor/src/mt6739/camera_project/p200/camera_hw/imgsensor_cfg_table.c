...
#if defined(OV8856_SUNWIN_P200_MIPI_RAW)
						{
							SENSOR_DRVNAME_OV8856_SUNWIN_P200_MIPI_RAW,
							{
...
#if defined(S5K3L8_OFILM_P200_MIPI_RAW)
		{
			SENSOR_DRVNAME_S5K3L8_OFILM_P200_REAR_MIPI_RAW,
			{
				{SensorMCLK, Vol_High, 0},
				{PDN, Vol_Low, 1},
				{RST, Vol_Low, 1},
...
#endif
#if defined(S5K3L8_SUNWIN_P200_MIPI_RAW)
		{
			SENSOR_DRVNAME_S5K3L8_SUNWIN_P200_REAR_MIPI_RAW,
			{
				{SensorMCLK, Vol_High, 0},
				{PDN, Vol_Low, 1},
				{RST, Vol_Low, 1},
...
#if defined(GC5025_HOLITECH_P200_MIPI_RAW)
						{
							SENSOR_DRVNAME_GC5025_HOLITECH_P200_MIPI_RAW,
							{
				                {SensorMCLK1, Vol_High, 0},
				                {PDN, Vol_Low, 1},
				                {RST, Vol_Low, 1},
...
#endif
#if defined(GC5025_SUNWIN_P200_MIPI_RAW)
						{
							SENSOR_DRVNAME_GC5025_SUNWIN_P200_MIPI_RAW,
							{
				                {SensorMCLK1, Vol_High, 0},
				                {PDN, Vol_Low, 1},
				                {RST, Vol_Low, 1},
