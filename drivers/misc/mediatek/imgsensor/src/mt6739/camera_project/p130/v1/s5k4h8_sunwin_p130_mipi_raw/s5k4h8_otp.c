...
#define RGr_ratio_Typical  601	//modify by v3702 
#define BGr_ratio_Typical  723  //modify by v3702
#define GbGr_ratio_Typical  1023
...
void Darling_S5K4H8_read_OTP(void)
{
	...
	if(val == 0x01)
	{
		...
		RGr_ratio =(S5K4H8_byteread_cmos_sensor(0x0A0D)<<8)|S5K4H8_byteread_cmos_sensor(0x0A0C);
		BGr_ratio =(S5K4H8_byteread_cmos_sensor(0x0A0F)<<8)|S5K4H8_byteread_cmos_sensor(0x0A0E);
		GbGr_ratio =(S5K4H8_byteread_cmos_sensor(0x0A11)<<8)|S5K4H8_byteread_cmos_sensor(0x0A10);
		...
		SENSORDB_S5K4H8_OTP("HYNIX_CAM_CAL RGr_ratio= 0x%x, BGr_ratio = 0x%x, GbGr_ratio = 0x%0x",RGr_ratio,BGr_ratio,GbGr_ratio);
		SENSORDB_S5K4H8_OTP("HYNIX_CAM_CAL S5K4H8 otp_4h8_af_data[0]= 0x%x, otp_4h8_af_data[1] = 0x%x",(S5K4H8_byteread_cmos_sensor(0x0A32)<<8)|S5K4H8_byteread_cmos_sensor(0x0A31),(S5K4H8_byteread_cmos_sensor(0x0A34)<<8)|S5K4H8_byteread_cmos_sensor(0x0A33));
   ...
   a = (a26+a27+a28+a29+a30+a31+a32+a33+a34+a35+a36+a37+a38+a39)%0xff+1;
	...
	{
		flag_otp += 0x04;
		otp_4h8_af_data[0] =(S5K4H8_byteread_cmos_sensor(0x0A32)<<8)|S5K4H8_byteread_cmos_sensor(0x0A31);
		otp_4h8_af_data[1]=(S5K4H8_byteread_cmos_sensor(0x0A34)<<8)|S5K4H8_byteread_cmos_sensor(0x0A33);
	...
	{
		flag_otp += 0x04;
		otp_4h8_af_data[0] =(S5K4H8_byteread_cmos_sensor(0x0A39)<<8)|S5K4H8_byteread_cmos_sensor(0x0A38);
