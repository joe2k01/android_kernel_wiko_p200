...
/* make gc8034_cxt_k600_eeprom co-exist */
...
*
********************************************************************************/
#define CAM_CAL_DRVNAME "GC8034_CXT_K600_CAL_DRV"
...
extern u16 gc8034_cxt_k600_af_data[2];
u8 GC8034_CXT_K600_CheckID[]= {0x10,0xff,0x00,0x40,0x88};
...
{    	
	...
	if(size ==2 ){
		if(offset == 7){
			memcpy((void *)data,(void *)&gc8034_cxt_k600_af_data[0],size);
			CAM_CALDB("gc8034_cxt_k600_af_data[0] = 0x%x\n", gc8034_cxt_k600_af_data[0]);

		}
		else if(offset == 9){		 
			memcpy((void *)data,(void *)&gc8034_cxt_k600_af_data[1],size);
			CAM_CALDB("gc8034_cxt_k600_af_data[1] = 0x%x\n",gc8034_cxt_k600_af_data[1]);

		}
	}
	if(size == 4){
		memcpy((void *)data,(void *)&GC8034_CXT_K600_CheckID[1],size);
		CAM_CALDB("+ls.test[GC8034_CAM_CAL]  data1 = %d\n",*(unsigned char*)data);
	}
}
/********************************************************************************/
...
static inline int RegisterCAM_CALCharDrv(void)
{
	...
	CAM_CAL_class = class_create(THIS_MODULE, "GC8034_CXT_K600_CAL_DRV");
...
static int __init GC8034_CXT_k600_CAM_CAL_init(void)
{
...
static void __exit GC8034_CXT_k600_CAM_CAL_exit(void)
{
	platform_driver_unregister(&g_stCAM_CAL_Driver);
}

module_init(GC8034_CXT_k600_CAM_CAL_init);
module_exit(GC8034_CXT_k600_CAM_CAL_exit);

MODULE_DESCRIPTION("GC8034_CXT_k600_CAM_CAL driver");
MODULE_AUTHOR("tinno");
MODULE_LICENSE("GPL");
