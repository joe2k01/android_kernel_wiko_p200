...
#include "gc5025_sunniness_k600_front_mipi_sensor.h"

/****************************Modify Following Strings for Debug****************************/
#define PFX "GC5025_SUNNINESS_FRONT_camera_sensor"
#define LOG_1 LOG_INF("GC5025_SUNNINESS_FRONT,MIPI 2LANE\n")
/****************************   Modify end    *******************************************/
...
static imgsensor_info_struct imgsensor_info = {
       .sensor_id = GC5025_SUNNINESS_K600_FRONT_SENSOR_ID,        //record sensor id defined in Kd_imgsensor.h
...
typedef struct gc5025_sunniness_k600_front_otp_info
{
...
}gc5025_sunniness_k600_front_otp_info;

static gc5025_sunniness_k600_front_otp_info gc5025_otp_info;
		...
		do {
			*sensor_id = return_sensor_id() - 2;
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				if(gc5025_otp_info.module_id == 0x14 && gc5025_otp_info.lens_id == 0x01){
...
UINT32 GC5025_SUNNINESS_K600_FRONT_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{    
	printk("cz GC5025 sunniness k600 front MIPI_RAW_SensorInit\n");
