...
#include "gc5025_cmk_k600_mipi_sensor.h"

/****************************Modify Following Strings for Debug****************************/
#define PFX "GC5025_CMK_camera_sensor"
#define LOG_1 LOG_INF("GC5025_CMK,MIPI 2LANE\n")
/****************************   Modify end    *******************************************/
...
static imgsensor_info_struct imgsensor_info = {
       .sensor_id = GC5025_CMK_K600_SENSOR_ID,        //record sensor id defined in Kd_imgsensor.h
...
#define RG_TYPICAL    		0x4ca//0x0400
#define BG_TYPICAL		0x4de//0x0400
...
typedef struct gc5025_cmk_k600_otp_info
{
...
}gc5025_cmk_k600_otp_info;

static gc5025_cmk_k600_otp_info  gc5025_otp_info;
		...
		do {
			...
			*sensor_id = *sensor_id + 1; 
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				LOG_INF("gc5025_otp_info.module_id: 0x%x\n", gc5025_otp_info.module_id);
				if(gc5025_otp_info.module_id == 0x08){
...
UINT32 GC5025_CMK_K600_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{    
	printk("cz GC5025 cmk k600 MIPI_RAW_SensorInit\n");
