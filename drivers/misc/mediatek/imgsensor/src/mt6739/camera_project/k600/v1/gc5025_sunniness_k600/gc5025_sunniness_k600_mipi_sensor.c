...
#include "gc5025_sunniness_k600_mipi_sensor.h"

/****************************Modify Following Strings for Debug****************************/
#define PFX "GC5025_SUNNINESS_camera_sensor"
#define LOG_1 LOG_INF("GC5025_SUNNINESS,MIPI 2LANE\n")
/****************************   Modify end    *******************************************/
...
static imgsensor_info_struct imgsensor_info = {
       .sensor_id = GC5025_SUNNINESS_K600_SENSOR_ID,        //record sensor id defined in Kd_imgsensor.h

       .checksum_value = 0xa9448b7d,//0xf7375923,        //checksum value for Camera Auto Test
...
typedef struct gc5025_sunniness_k600_otp_info
{
...
}gc5025_sunniness_k600_otp_info;

static gc5025_sunniness_k600_otp_info gc5025_otp_info;
		...
		do {
			...
			*sensor_id = *sensor_id + 2;
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				if(gc5025_otp_info.module_id == 0x14 && gc5025_otp_info.lens_id == 0x07){
...
UINT32 GC5025_SUNNINESS_K600_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{    
	printk("cz GC5025 sunniness k600 MIPI_RAW_SensorInit\n");
