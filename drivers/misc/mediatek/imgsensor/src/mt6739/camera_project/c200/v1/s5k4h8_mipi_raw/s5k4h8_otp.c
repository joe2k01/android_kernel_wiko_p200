...
#define RGr_ratio_Typical  600	//modify by v3702 
#define BGr_ratio_Typical  721  //modify by v3702
#define GbGr_ratio_Typical  1019
...
void Darling_S5K4H8_read_OTP(void)
{
	...
	if(val == 0x01)
		...
		a38 =    S5K4H8_byteread_cmos_sensor(0x0A33);
		 ...
		 RGr_ratio =(S5K4H8_byteread_cmos_sensor(0x0A23)<<8)|S5K4H8_byteread_cmos_sensor(0x0A22);
		 BGr_ratio =(S5K4H8_byteread_cmos_sensor(0x0A25)<<8)|S5K4H8_byteread_cmos_sensor(0x0A24);
		 GbGr_ratio =(S5K4H8_byteread_cmos_sensor(0x0A27)<<8)|S5K4H8_byteread_cmos_sensor(0x0A26);
