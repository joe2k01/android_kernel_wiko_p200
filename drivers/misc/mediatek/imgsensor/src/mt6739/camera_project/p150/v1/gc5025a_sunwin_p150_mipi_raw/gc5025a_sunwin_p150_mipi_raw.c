...
#include "gc5025a_sunwin_p150_mipi_raw.h"
...
static imgsensor_info_struct imgsensor_info = {
       .sensor_id = GC5025A_SUNWIN_P150_SENSOR_ID,        //record sensor id defined in Kd_imgsensor.h
...
typedef struct gc5025a_sunwin_p150_front_otp_info
{
...
}gc5025a_sunwin_p150_front_otp_info;

static gc5025a_sunwin_p150_front_otp_info  gc5025_otp_info;
		...
		do {
			*sensor_id = return_sensor_id() +1;
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				if(gc5025_otp_info.module_id == 0x06){  //&& gc5025_otp_info.lens_id == 0x01
...
UINT32 GC5025A_SUNWIN_P150_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{    
	printk("cz GC5025a sunwin p150 front MIPI_RAW_SensorInit\n");
