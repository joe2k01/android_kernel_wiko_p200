...
//define printk_LOD(format, args...)	pr_debug(ANDROID_printkO   , PFX, "[%s] " format, __FUNCTION__, ##args)
...
static imgsensor_info_struct imgsensor_info = { 
	.sensor_id = S5K3L8_OFILM_P150_REAR_SENSOR_ID,		//Sensor ID Value: 0x30C8//record sensor id defined in Kd_imgsensor.h
	
	.checksum_value = 0x43c06399,		//checksum value for Camera Auto Test
...
static SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[10] =	 
{
 ...
 { 4208, 3120,	  0,  	0, 4208, 3120, 2104, 1560,   0,	0, 2104, 1560, 	 4, 4, 2096, 1552}, // video 
...
*
*************************************************************************/
extern s5k3l8_ofilm_p150_otp_info  s5k3l8_ofilm_otp_info;
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
    ...
    while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		s5k3l8_ofilm_p150_read_eeprom_data();	
		printk("s5k3l8_ofilm_otp_info.module_id: 0x%x,lens_id = 0x%x\n", s5k3l8_ofilm_otp_info.module_id,s5k3l8_ofilm_otp_info.lens_id);
		if(s5k3l8_ofilm_otp_info.module_id == 0x11){
                             ...
                             UINT8 *feature_para,UINT32 *feature_para_len)
{
    ...
    switch (feature_id) {
		...
		case SENSOR_FEATURE_GET_PDAF_DATA:	
			...
			//s5k3l8_ofilm_p150_read_eeprom((kal_uint16 )(*feature_data),(char*)(uintptr_t)(*(feature_data+1)),(kal_uint32)(*(feature_data+2)));
			break;	
        /******************** PDAF END   <<< *********/
        default:
            break;
...
MUINT32 S5K3L8_OFILM_P150_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
