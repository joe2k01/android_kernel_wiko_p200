...
#include "s5k4h7yx_sunwin_p150_mipi_raw.h"
...
static DEFINE_SPINLOCK(imgsensor_drv_lock);
	...
	extern int tran_otp_manual_control;
#endif
...
static imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5K4H7YX_SUNWIN_P150_SENSOR_ID,
...
static SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] = {
 ...
 { 3264, 2448,	  0,	0, 3264, 2448, 1632,  1224, 0000, 0000, 1632, 1224,	    0,	4, 1632, 1216}, /* Preview */
 { 3264, 2448,	  0,	0, 3264, 2448, 3264,  2448, 0000, 0000, 3264, 2448,	    0,	8, 3264, 2432}, /* capture */
 { 3264, 2448,	  0,	0, 3264, 2448, 3264,  2448, 0000, 0000, 3264, 2448,	    0,	8, 3264, 2432}, /* video */
...
UINT32 S5K4H7YX_SUNWIN_P150_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
