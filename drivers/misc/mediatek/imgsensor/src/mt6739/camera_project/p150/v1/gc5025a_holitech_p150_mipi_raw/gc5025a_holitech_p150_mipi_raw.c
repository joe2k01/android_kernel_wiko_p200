...
#include "gc5025a_holitech_p150_mipi_raw.h"
...
static imgsensor_info_struct imgsensor_info = {
       .sensor_id = GC5025A_HOLITECH_P150_SENSOR_ID,        //record sensor id defined in Kd_imgsensor.h
...
#define RG_TYPICAL    		0x4e1//0x0579//0x0400
#define BG_TYPICAL		0x4fc//0x0544//0x0400
...
typedef struct gc5025a_holitech_p150_front_otp_info
{
...
}gc5025a_holitech_p150_front_otp_info;

static gc5025a_holitech_p150_front_otp_info  gc5025_otp_info;
...
{	
	...
	else
	{
		...
		write_cmos_sensor(0xb1, temp>>6);
		write_cmos_sensor(0xb2, (temp<<2)&0xfc);
		LOG_INF("GC5025MIPI analogic gain 2x, GC5025MIPI add pregain = %d\n", temp);
	}
	return gain;
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				LOG_INF("gc5025_otp_info.module_id: 0x%x,lens_id = 0x%x\n", gc5025_otp_info.module_id,gc5025_otp_info.lens_id);
				if(gc5025_otp_info.module_id == 0x42){  //&& gc5025_otp_info.lens_id == 0x01
...
UINT32 GC5025A_HOLITECH_P150_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{    
	printk("cz GC5025a holitech p150 front MIPI_RAW_SensorInit\n");
