...
UINT32 S5K4H8_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);   //c200
UINT32 S5K4H8_CD_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);   //c201
...
UINT32 S5K3L8_SUNWIN_C300_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
...
UINT32 S5K3L8_SUNWIN_P150_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
UINT32 GC5025A_HOLITECH_P150_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
UINT32 S5K3L8_OFILM_P150_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
...
UINT32 S5K3L8_SUNWIN_P200_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
UINT32 S5K3L8_OFILM_P200_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
